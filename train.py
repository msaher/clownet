...
from pycoviar.transforms import GroupCenterCrop
from pycoviar.transforms import GroupScale
...
iframe_args = {
    ...
    'train_list': './dummy-data/list.txt',
    'model_prefix': 'ayo',
    'lr_steps': [55, 110, 165],
    'epochs': 220,
    'gpus': 1,
...
def main(d: dict):
    ...
    for epoch in range(args.epochs):
        cur_lr = adjust_learning_rate(optimizer, epoch, args.lr_steps, args.lr_decay, args)
...
def train(train_loader, model, criterion, optimizer, epoch, cur_lr, args):
...
def adjust_learning_rate(optimizer, epoch, lr_steps, lr_decay, args):
